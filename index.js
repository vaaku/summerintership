...
search.addEventListener('click', () => {
    const APIKey = 'b726ebbe00848d4e47d4d67d437621d8';
    ...
    fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=${APIKey}`)
        ...
        .then(json => {
            ...
            weatherBox.classList.add('slideDown');
...
searchBoxInput.addEventListener('change', function() {
    weatherBox.classList.add('colorChange');
    setTimeout(() => {
        weatherBox.classList.remove('colorChange');
    }, 1000);
});
